...
<head>
    ...
    <script>
        function opcionOficial(that) {
            if (that.value == "Oficial") {
                document.getElementById("codigoTransT").style.display = "";
            } else {
                document.getElementById("codigoTransT").style.display = "none";
            }
        }
    </script>
</head>
