        ...
        <div class="col-12 px-4">
            <div class="row bg-dark text-white">
                <div class="col text-center">
                    <h3> Clientes con mayor número de facturas </h3>
                </div>
            </div>
            <table class="table-sm table-bordered table-striped" >
                ...
                <tbody>
                    <?php
                        require('Select_ConsultaClientesMasFacturas.php');
                        if ($result){
                            foreach ($result as $fila){
                    ?>
                    <tr>
                        <td class="text-center" style="width: 1050px;"><?=$fila['tipodoc'];?></td>
                        <td class="text-center" style="width: 1050px;"><?=$fila['numerodeid'];?></td>
                        <td class="text-center" style="width: 1050px;"><?=$fila['nombrecompleto'];?></td>
