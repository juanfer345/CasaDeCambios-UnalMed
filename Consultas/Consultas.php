...
<body>
    ...
    <div class="card">
        ...
        <div class="card-body">
        <form action="ConsultaFacturaNoAsociadas.php" method="GET" class="form-group">
            <button class="btn btn-success" title="ConsultaFacturaNoAsociadas" type="submit">
                Consultar facturas sin titular
            </button>
        </form>

        <form action="ConsultaClientesMasFacturas.php" method="GET" class="form-group">
            <button class="btn btn-success" title="ConsultaClentesMasFacturas" type="submit">
                Cliente/s con mayor número de facturas
            </button>
        </form>

        <form action="ConsultaEmpresasMenor5000.php" method="GET" class="form-group">
            <button class="btn btn-success" title="ConsultaEmpresasMenor5000" type="submit">
