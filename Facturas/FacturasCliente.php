                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="Update_f.php" class="form-group" method="post">
                                ...
                                <!--Número y tipo de identificación de cliente-->
                                <div class="form-group">
                                    ...
                                    <label> Número y tipo de documento: </label><br>

                                    <?php
                                        $codigo = $_GET["numerodeidcliente"] . '(' . $_GET["tipodoccliente"] . ')';
                                        $mostrar = $_GET["numerodeidcliente"] . ' (' . $_GET["tipodoccliente"] . ')';
                                    ?>

                                    <select style="width: 250px;" name="idcliente">
                                        <option value='<?=$codigo;?>' selected hidden> <?=$mostrar;?> </option>

                                        <?php
                                        require('../Conexion.php');

                                        $query = "SELECT numerodeid, tipodoc FROM cliente";
                                        $result = mysqli_query($conn, $query);

                                        if ($result){
                                            foreach ($result as $fila) {
                                                $codigo = $fila['numerodeid'] . '(' . $fila['tipodoc'] . ')';
                                                $mostrar = $fila['numerodeid'] . ' (' . $fila['tipodoc'] . ')';
                                                ?>
                                                <option value=<?=$codigo;?>> <?=$mostrar;?> </option>
                                            <?php } 
                                        }
                                        ?>
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <a href="FacturasCliente.php" class="btn btn-danger"> Descartar </a>
                                </div>
                            </form>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form action="FacturasTitular.php" class="form-group" method="post">
                                <div class="form-group">
                                    ...
                                    <select style="width: 250px;" name="tipotit" id="tipotit">
                                        <option value="cliente" selected> Insertar factura para cliente </option>
                            ...
                            <form action="Insert_f.php" class="form-group" method="post">
                                ...
                                <div class="form-group">
                                    <label> Número y tipo de documento: </label><br>
                                    <select style="width: 250px;" name="idcliente" id="idcliente">
                                    	<?php
                                    	require('../Conexion.php');
                                ...
                                <div class="form-group">
                                    ...
                                    <a href="FacturasCliente.php" class="btn btn-danger"> Reiniciar </a>
                                </div>
                            </form>
                        </div>
                    </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center" style="width: 250px;">
                                <form action="FacturasCliente.php" method="GET">
                                    ...
                                    <input type="text" name="numerodeidcliente" value='<?=$fila['numerodeidcliente'];?>' hidden>
                            ...
                            <td class="text-center" style="width: 250px;">
                                <form action="Delete_f.php" method="POST">
                                    <input type="text" name="idcliente" value='<?=$fila['codigo'];?>' hidden>
