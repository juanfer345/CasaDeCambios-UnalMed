                        ...
                        <div class="card-body">
                            <form action="Update_f.php" class="form-group" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <a href="FacturasNinguno.php" class="btn btn-danger"> Descartar </a>
                                </div>
                            </form>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            ...
                            <form action="FacturasTitular.php" class="form-group" method="post">
                                <div class="form-group">
                                    ...
                                    <select style="width: 250px;" name="tipotit" id="tipotit">
                                        ...
                                        <option value="ninguno" selected> Insertar factura sin titular </option>
                            ...
                            <form action="Insert_f.php" class="form-group" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <a href="FacturasNinguno.php" class="btn btn-danger"> Reiniciar </a>
                                </div>
                            </form>
                        </div>
                    </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center" style="width: 250px;">
                                <form action="FacturasNinguno.php" method="GET">
